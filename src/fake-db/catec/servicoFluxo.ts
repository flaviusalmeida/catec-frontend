...
const fluxoPorServico: Record<number, CatecServicoFluxoData> = {
  1: {
    propostas: [
      {
        id: 101,
...
function cloneFluxo(data: CatecServicoFluxoData): CatecServicoFluxoData {
  return JSON.parse(JSON.stringify(data)) as CatecServicoFluxoData
}

export function getInitialServicoFluxoData(servicoId: number): CatecServicoFluxoData {
  const base = fluxoPorServico[servicoId]
...
/** @deprecated use computeServicoFluxoResumo com dados do store */
export function getServicoFluxoResumo(servicoId: number): CatecServicoFluxoResumo {
  return computeServicoFluxoResumo(servicoId, getInitialServicoFluxoData(servicoId))
}
