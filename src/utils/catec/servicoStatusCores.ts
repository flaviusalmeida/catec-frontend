...
export const STATUS_SERVICO_PAINEL_CORES: Record<CatecServicoStatus, StatusCorPainel> = {
...
export function corGraficoServicoStatus(status: CatecServicoStatus): string {
  return STATUS_SERVICO_PAINEL_CORES[status].main
}

export function corPainelServicoStatus(status: CatecServicoStatus): StatusCorPainel {
  return STATUS_SERVICO_PAINEL_CORES[status]
}
