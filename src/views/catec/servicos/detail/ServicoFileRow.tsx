...
import ServicoDocumentoPreviewDrawer from './ServicoDocumentoPreviewDrawer'
import ServicoMetaItensGrid, { type ServicoMetaItem } from './ServicoMetaItensGrid'

type Props = {
  nomeArquivo: string
  meta?: string
  metaComplementar?: ReactNode
  metaItens?: ServicoMetaItem[]
  status?: ReactNode
  extra?: ReactNode
  documentoId?: number
        ...
        <div className='flex items-start gap-3 min-is-0 flex-1'>
          ...
          <div className='min-is-0 flex-1'>
            ...
            {metaItens && metaItens.length > 0 ? (
              <div className='mts-2'>
                <ServicoMetaItensGrid itens={metaItens} />
              </div>
            ) : null}
