...
export type ServicoAtividadeLinhaVariant = 'etapa' | 'atividade' | 'subatividade'

type Props = {
  atividade: CatecAtividade
  variant: ServicoAtividadeLinhaVariant
  expansivel?: boolean
  aberta?: boolean
  onToggle?: () => void
...
export default ServicoAtividadeLinha
