...
import ServicoTimeline from './ServicoTimeline'
...
const ServicoTabHistorico = ({ fluxo }: Props) => {
  ...
  if (historicoPage.totalElements === 0 && !historicoCarregando) {
    return <ServicoStateCard titulo='Nenhum histórico disponível.' />
  }
  ...
  return (
    <Card>
      ...
      <CardContent>
        <ServicoTimeline items={timeline} />
        <TablePagination
          component='div'
...
export default ServicoTabHistorico
