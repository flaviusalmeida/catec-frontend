...
const ServicoAddDrawer = ({ open, onClose, clientes, onAdd }: Props) => {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (!responsavel?.email?.trim() && !clienteSelecionado.email?.trim()) {
    ...
    try {
      ...
      toast.error(err instanceof Error ? err.message : 'Não foi possível criar o servico.')
    } finally {
      setSalvando(false)
    }
  }
  ...
  return (
    ...
    >
      <div className='flex items-center justify-between plb-5 pli-6'>
        <Typography variant='h5'>Novo servico</Typography>
...
export default ServicoAddDrawer
