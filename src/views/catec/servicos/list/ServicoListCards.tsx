...
import type { CatecServico, CatecServicoResumo, CatecServicoResumoCardStatus } from '@/types/catec/servicoTypes'
...
const ServicoListCards = ({ lista, resumo }: Props) => {
...
export default ServicoListCards
