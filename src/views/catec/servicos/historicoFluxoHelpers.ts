...
import { ORIGEM_RESPOSTA_ROTULO, TIPO_INTERACAO_ROTULO_PROPOSTA } from '@/types/catec/servicoFluxoTypes'
...
export type HistoricoEntidadeTipo = 'SERVICO' | 'PROPOSTA' | 'CONTRATO'
